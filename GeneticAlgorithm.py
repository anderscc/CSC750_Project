...
class Schedule:
    ...
    def initialize(self):
        ...
        for cur_lab in LabTAPref:
            ...
            ga_work_load[TA.get_studentName()] -= cur_lab.get_activityTimes()

        # Iterate through all courses and labs
        # Iterate through all courses to assign a TAGA
        ...
        for cur_lab in LabNonTAPref:
            ...
            # Subtract hours from the dict
            ga_work_load[gata.get_studentName()] -= cur_lab.get_activityTimes()
    ...
    def calculate_fitness(self):
        ...
        for cur_course_assignment in assignments:
            ...
            assigned_gata = cur_course_assignment.get_gata()
            # print("FIND ME")
